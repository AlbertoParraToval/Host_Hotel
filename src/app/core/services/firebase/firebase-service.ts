...
export const FIRESTORE_MANAGEMENT_COLLECTION = 'hostHotel-driverManages';
export const FIRESTORE_IMAGES_COLLECTION = 'hostHotel-images';
export const FIRESTORAGE_PREFIX_PATH = 'hostHotel-images';
